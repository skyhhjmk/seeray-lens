...
| Visitor intelligence | Anonymous site-scoped visitor profiles with lifetime first/last seen and visit totals, date/segment-filtered history (latest 50 visits and 100 actions), saved segments, technology and trusted-proxy location dimensions, weekly first-visit cohorts with retention matrix and first-session segment filtering | Cursor-based deep-history browsing, cross-device authenticated identity linking, and richer cohort definitions |
