...
| Visitor intelligence | Anonymous site-scoped visitor profiles with lifetime first/last seen and visit totals, date/segment-filtered keyset-paged history (50 visits and 100 actions per page), saved segments, technology and trusted-proxy location dimensions, weekly first-visit cohorts with retention matrix and first-session segment filtering | Cross-device authenticated identity linking, richer cohort definitions, and browser acceptance |
