...
| Conversion | Goal rules, value, conversion session count/rate | Funnels, goal management UI, comparison and attribution reports |
| Tag manager | `seerayDataLayer` queue and event bridge | Containers, tags, triggers, variables, versions, publish/rollback and preview |
| Experimentation | None | Experiments, deterministic assignment, exposure/conversion analysis, experiment UI |
