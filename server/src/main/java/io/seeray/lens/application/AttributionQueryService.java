...
public class AttributionQueryService {
    ...
    public Report report(
        ...
        String sql = "with eligible_sessions as ("
                + "select s.id,s.site_id,s.visitor_id,v.client_visitor_id,s.client_session_id,s.started_at,s.last_activity_at,"
                ...
                + "conversions as (select s.site_id,s.id conversion_session_id,s.visitor_id,s.client_visitor_id,"
                ...
                + "group by s.site_id,s.id,s.visitor_id,s.client_visitor_id,g.id,g.name,g.fixed_value),"
                ...
                + "select s.id,s.site_id,s.visitor_id,s.started_at,s.initial_referrer_host,s.initial_utm_source,"
                ...
                + "from conversions c join classified_sessions t on t.site_id=c.site_id and t.visitor_id=c.visitor_id "
