...
/** Owner/admin view of recent human-user API reads for a workspace. */
@ApplicationScoped
public class WorkspaceReadAccessLogService {
    ...
    public WorkspaceReadAccessLogService(DataSource dataSource, WorkspaceAccess access) {
    ...
    public Page list(UUID workspaceId, String fromValue, String toValue, String cursorValue, int requestedLimit) {
        ...
        String sql = "select l.id,l.actor_user_id,u.email,l.site_id,s.name,l.method,l.route_template,"
                + "l.status_code,l.created_at from workspace_api_read_log l "
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            throw new IllegalStateException("Could not read workspace API access history", error);
        }
