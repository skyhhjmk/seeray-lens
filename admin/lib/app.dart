...
import 'features/analytics/presentation/yandex_webmaster_page.dart';
    ...
    routes: <RouteBase>[
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            path: '/sites/:siteId/acquisition/campaign-costs',
            pageBuilder: (context, state) => _siteTabPage(
              state,
              _Authenticated(
          ...
          GoRoute(
            path: '/sites/:siteId/acquisition/search-console',
            pageBuilder: (context, state) => _siteTabPage(
              state,
              _Authenticated(
          ...
          GoRoute(
            path: '/sites/:siteId/acquisition/yandex-webmaster',
            pageBuilder: (context, state) => _siteTabPage(
              state,
              _Authenticated(
                child: YandexWebmasterPage(
                  siteId: state.pathParameters['siteId']!,
                  embedded: true,
                ),
              ),
